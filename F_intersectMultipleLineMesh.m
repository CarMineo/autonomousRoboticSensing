...
%F_INTERSECTMULTIPLELINEMESH Computes the intersection points between 
%multiple 3D lines and a 3D mesh defined by vertices and faces.
%   [intersectionPoints, distFromOrigin, intersectedFaces] = F_intersectMultipleLineMesh(origin,lines,vertices,faces, varargin)
%
%   Inputs:
%       origins - [nx3] ray origins
...
%
%   F_intersectMultipleLineMesh v1.0
