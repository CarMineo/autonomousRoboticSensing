function [P,R,scanData] = F_getThirdPt(scanData,r,rDir,alpha)
%F_GETTHIRDPT computes the third sensor pose to visit in the execution of
...
iPts = [2; 1];
[P,R,scanData] = F_getNewTargetPt(scanData,iPts,r,rDir,alpha);
